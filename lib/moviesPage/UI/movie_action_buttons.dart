  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isDesktop) {
      return buildActionButton(
        ...
        iconColor: isWatchlist == true ? theme.primaryColor : Colors.white,
      ...
      return buildM3FloatingActionButton(
        context: context,
        backgroundColor: isWatchlist == true ? colorScheme.primaryContainer : null,
        borderColor: isWatchlist == true ? colorScheme.primary.withValues(alpha: 0.6) : null,
        onTap: _toggleWatchlist,
        child: Icon(
          isWatchlist == true ? Icons.bookmark_rounded : Icons.bookmark_border_rounded,
          color: isWatchlist == true ? colorScheme.primary : Colors.white,
          size: 22,
        ),
      );
    }
